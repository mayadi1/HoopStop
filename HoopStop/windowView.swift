...
class windowView : NSObject, UIGestureRecognizerDelegate
{
    ...
    func basicView(ViewController:UIViewController, arrayImages: [String], arrayTitles: [String])
    {
        self.modelView = 0
        self.iterator = 0
    ...
    func modernView(ViewController:UIViewController, arrayImages: [String], arrayTitles: [String])
    {
        self.modelView = 1
        self.iterator = 0
        self.alt = UIScreen.main.bounds.height
